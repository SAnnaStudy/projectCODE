...
function Sort({setOpenPop, sortType, setSortType}){
    return(
                ...
                <div className="pop_up_body" id="pop_up_body">
                    <div className="pop_up_content">
                        ...
                        <form action="" className="form">
                            <div className="form_item1 form_item">
                                <input type="radio" checked={sortType == 1 ? true: false} id='radioChoice1' name="radio" onChange={() => setSortType(1)} />
                                <label for='radioChoice1'>По алфавиту</label>
                            </div>
                            <div className="form_item">
                                <input type="radio" checked={sortType == 2 ? true: false} id='radioChoice2' name="radio" onChange={() => setSortType(2)} />
                                <label for='radioChoice2'>По дате рождения</label>
                            </div>
                        </form>
